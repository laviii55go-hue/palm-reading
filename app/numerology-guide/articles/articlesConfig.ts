...
//
export const ARTICLE_CUTOFF_DATE = "2026-03-18";
...
export const ARTICLES = [
  ...
  { slug: "money-work-ranking", emoji: "💰", title: "数秘術で金運・仕事運ランキング", desc: "4・8・22など、お金・キャリアに強いライフパスナンバーをランキング形式で解説。", publishedAt: "2026-04-08" },
