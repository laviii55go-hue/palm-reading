...
export const ARTICLES = [
  { slug: "tarot-beginners-guide", emoji: "🃏", title: "タロット占い やり方｜初心者向けワンカードの引き方と解釈", desc: "タロット占いのやり方を初心者向けに解説。ワンカードの引き方、YES/NO占い、カードの意味の読み方を紹介します。", publishedAt: "2026-06-14" },
