...
export const ARTICLES = [
  { slug: "animal-compatibility-ranking", emoji: "🤝", title: "動物占い 相性ランキング｜最も相性のいい組み合わせは？", desc: "動物占いの相性ランキングを紹介。12動物の中で相性の良い組み合わせ、恋愛・友人関係での相性の見方を解説します。", publishedAt: "2026-06-14" },
